...
const Shop = {
    ...
    drawRewardChip(cx, cy, uid) {
        ...
        if (r.streak) this._drawResultStreak(cx, rowY + 12, r.streak);
    },
...
const Cosmetics = {
    ...
    // ---------- ball ----------
    // Returns a finished, procedurally drawn ball (cached offscreen canvas) for
    // ANY skin id, including 'classic'. Never null and never depends on an
    // image file: this is what guarantees the ball always looks like a ball.
    ballSkinCanvas(id) {
